	...
	cutscene_intro:add_cinematic_trigger_listener(
		"wh3_dlc20_qb_nur_festus_pestilent_potions_pt_01", 
			function()
				...
				bm:show_subtitle("hkrul_baerson_einar_bubos_pt_01", false, true);
			end
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"wh3_dlc20_qb_nur_festus_pestilent_potions_pt_02", 
			function()
				...
				bm:show_subtitle("hkrul_baerson_einar_bubos_pt_02", false, true);
			end
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"wh3_dlc20_qb_nur_festus_pestilent_potions_pt_03", 
			function()
				...
				bm:show_subtitle("hkrul_baerson_einar_bubos_pt_03", false, true);
			end
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"wh3_dlc20_qb_nur_festus_pestilent_potions_pt_04", 
			function()
				...
				bm:show_subtitle("hkrul_baerson_einar_bubos_pt_04", false, true);
			end
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"wh3_dlc20_qb_nur_festus_pestilent_potions_pt_05", 
			function()
				...
				bm:show_subtitle("hkrul_baerson_einar_bubos_pt_05", false, true);
			end
	);
...
gb:set_objective_on_message("01_intro_cutscene_end", "hkrul_baerson_einar_bubos_main_objective");

-------------------------------------------------------------------------------------------------
--------------------------------------------- HINTS ---------------------------------------------
-------------------------------------------------------------------------------------------------

gb:queue_help_on_message("01_intro_cutscene_end", "hkrul_baerson_einar_bubos_start_battle", 7000, 2000, 0);
gb:queue_help_on_message("01_intro_cutscene_end", "hkrul_baerson_einar_bubos_cygors", 7000, 2000, 30000);
