...
gb:set_objective_with_leader_on_message("objective_01", "hkrul_skoroth_objective_01");
gb:complete_objective_on_message("kho_dead", "hkrul_skoroth_objective_01");

gb:set_objective_with_leader_on_message("objective_02", "hkrul_skoroth_objective_02");
gb:complete_objective_on_message("sla_dead", "hkrul_skoroth_objective_02");

gb:set_locatable_objective_callback_on_message(
    "nur_boss_in",
    "hkrul_skoroth_objective_03",
    0,
    function()
...
gb:complete_objective_on_message("nur_boss_dead", "hkrul_skoroth_objective_03");

gb:queue_help_on_message("hint_01", "hkrul_skoroth_hint_01");
gb:queue_help_on_message("dae_weaker", "hkrul_skoroth_hint_02");
