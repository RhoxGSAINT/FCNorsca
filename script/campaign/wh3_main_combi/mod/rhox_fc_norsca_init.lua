...
local rhox_faction_list={
    ...
    wh_main_nor_bjornling ={
        leader={
            ...
            unit_list="hkrul_bjornling_inf_marauder_spearman_0,rhox_bjornling_huscarl_ror,wh_dlc08_nor_mon_norscan_giant_0,hkrul_bjornling_inf_marauder_champions_0",
            x=434,
            y=858,
