...
cm:add_first_tick_callback(
    function()
        if cm:get_local_faction_name(true) == bjornling_faction then
            mixer_disable_hero_recruitment(bjornling_faction, "wh_dlc08_nor_fimir_balefiend_fire", "dignitary", "", true, true)
            mixer_disable_hero_recruitment(bjornling_faction, "wh_dlc08_nor_fimir_balefiend_shadow", "dignitary", "", true, true)
