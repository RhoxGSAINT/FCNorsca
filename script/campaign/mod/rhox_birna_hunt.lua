...
core:add_listener(
    ...
    function(context)
        local turn = cm:model():turn_number();
        local faction = context:faction()
        local mm = mission_manager:new(faction:name(), "hkrul_sarl_birna_bogtusk_mission_1")
...
--[[--WIP
local birna_mission_chain={
    hkrul_sarl_birna_bogtusk_mission_1="hkrul_sarl_birna_bogtusk_mission_2",
    hkrul_sarl_birna_bogtusk_mission_2="hkrul_sarl_birna_bogtusk_mission_3",
    hkrul_sarl_birna_bogtusk_mission_3="hkrul_sarl_birna_bogtusk_mission_4",
    hkrul_sarl_birna_bogtusk_mission_4="hkrul_sarl_birna_bogtusk_final_battle",
    
}

core:add_listener(
    "rhox_birna_mission_chain",
    "MissionSucceeded",
    function(context)    
        local mission_key = context:mission():mission_record_key();
        return birna_mission_chain[mission_key]
    end,
    function(context)
        local mission_key = context:mission():mission_record_key();
        local new_mission_key = birna_mission_chain[mission_key]
        local faction_key = context:faction():name();
        cm:trigger_mission(faction_key, new_mission_key, true)
    end,
    true
)
--]]
