...
core:add_ui_created_callback(
	function(context)
		if vfs.exists("script/frontend/mod/mixer_frontend.lua")then
			...
			mixer_add_starting_unit_list_for_faction("wh_main_nor_baersonling", {"dead_drenok_ice_bears","hkrul_dummy_baersonling_inf_chaos_marauders_0","wh3_dlc24_tze_mon_cockatrice","hkrul_dummy_baersonling_marauder_hunters_0","hkrul_dummy_baersonling_chaos_marauders_1","hkrul_norsca_ymir_ror"})
			...
			mixer_add_starting_unit_list_for_faction("wh_main_nor_bjornling", {"hkrul_bjornling_inf_marauder_champions_0","hkrul_bjornling_inf_chaos_marauders_1","rhox_bjornling_maneater","rhox_bjornling_huscarl_ror","hkrul_bjornling_inf_marauder_hunters_0","wh_dlc08_nor_mon_norscan_giant_0","hkrul_bjornling_inf_marauder_spearman_0"})
